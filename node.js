...
function setPanelColor(){
    var panel_color_op1 = document.getElementById("fill-panel-color").value.trim();
    ...
    } else if(panel_color_op2 && panel_color_op2 !=="#ffffff" || panel_color_op2 !== String(panel_color_op1)){
        paintcanv.style.backgroundColor = 'white';
